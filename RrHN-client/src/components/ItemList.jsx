...
class ItemListUI extends React.Component {
   ...
   render() {
      let listSize = parseInt(this.props.listSize) || 1  // if no useful number is antered, use value 1
      listSize = Math.max(listSize, 1)  // if a low number (<=0) is entered, use value 1
      const itemsToShow = this.props.items.slice(0, listSize)  // this also works when listSize > items.length.
