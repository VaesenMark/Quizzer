...
class ItemListUI extends React.Component {
    ...
    render() {
        ...
        if (this.props.items) {
            itemsToShow = this.props.items.slice(0, this.props.listSize)  // this also works when listSize > items.length.

            theItems = itemsToShow.map((itm, idx) =>
                <Item item={itm}
...
function ListFooter(props) {
    return <footer id="ListFooter">visual design based on <a
        href="http://blog.trackduck.com/weekly/top-10-hacker-news-redesigns/unknown-author-2/">this redesign by unknown
        author</a>.</footer>
}
